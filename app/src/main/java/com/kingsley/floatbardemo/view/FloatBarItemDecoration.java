 ...
 */
package com.kingsley.floatbardemo.view;
...
public class FloatBarItemDecoration extends RecyclerView.ItemDecoration {
    ...
    public FloatBarItemDecoration(Context context, Map<Integer, String> list) {
